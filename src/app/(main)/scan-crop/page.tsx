              ...
              >
                {imagePreview ? (
                  ...
                  <div className="text-center text-muted-foreground">
                    ...
                    <p>{t({ en: "Click to upload or drag & drop", ml: "അപ്‌ലോഡ് ചെയ്യാൻ ക്ലിക്കുചെയ്യുക അല്ലെങ്കിൽ വലിച്ചിടുക", hi: "अपलोड करने के लिए क्लिक करें या खींचें और छोड़ें", ta: "பதிவேற்ற கிளிக் செய்யவும் அல்லது இழுத்து விடவும்", te: "అప్‌లోడ్ చేయడానికి క్లిక్ చేయండి లేదా లాగి వదలండి", kn: "ಅಪ್‌ಲೋಡ್ ಮಾಡಲು ক্লিক ಮಾಡಿ ಅಥವಾ ಎಳೆದು ಬಿಡಿ", bn: "আপলোড করতে ক্লিক করুন বা拖และ放", mr: "अपलोड करण्यासाठी क्लिक करा किंवा ड्रॅग आणि ड्रॉप करा", gu: "ਅੱਪਲੋడ్ કરવા માટે ક્લિક કરો અથવા ਡਰੈਗ ਅਤੇ ਡਰਾਪ ਕਰੋ", pa: "ਅੱਪਲੋడ్ ਕਰਨ ਲਈ ਕਲਿੱਕ ਕਰੋ ਜਾਂ ਡਰੈਗ ਅਤੇ ਡ్రాਪ ਕਰੋ" })}</p>
                    <p className="text-xs">{t({ en: "PNG, JPG, WEBP up to 4MB", ml: "PNG, JPG, WEBP 4MB വരെ", hi: "PNG, JPG, WEBP 4MB तक", ta: "PNG, JPG, WEBP 4MB வரை", te: "PNG, JPG, WEBP 4MB వరకు", kn: "PNG, JPG, WEBP 4MB ವರೆಗೆ", bn: "PNG, JPG, WEBP 4MB পর্যন্ত", mr: "PNG, JPG, WEBP 4MB पर्यंत", gu: "PNG, JPG, WEBP 4MB સુધી", pa: "PNG, JPG, WEBP 4MB ਤੱਕ" })}</p>
                  </div>
                )}
              </div>
              <Input
