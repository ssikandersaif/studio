...
export default function VoiceQueryPage() {
  ...
  const transcribeAudio = async (audio: string) => {
    ...
    try {
      ...
      toast({
        variant: "destructive",
        title: t({ en: "Transcription Error", ml: "ട്രാൻസ്ക്രിപ്ഷൻ പിശക്", hi: "प्रतिलेखन त्रुटि", ta: "ട്രാൻസ്ക്രിപ്ഷൻ പിശക്", te: "ట్రాన్స్క్రిప్ஷன் లోపం", kn: "ಟ്രാנסಕ್ರಿప్ഷನ್ ದೋಷ", bn: " প্রতিলিপি ত্রুটি", mr: "ट्रान्सक्रिप्शन त्रुटी", gu: "ટ્રાન્સક્રિપ્ਸ਼ਨ ભૂલ", pa: "ਟ੍ਰਾਂਸਕ੍ਰਿਪਸ਼ਨ ਗਲਤੀ" }),
        description: t({ en: "Failed to transcribe your voice. Please try again.", ml: "നിങ്ങളുടെ ശബ്ദം പകർത്തുന്നതിൽ പരാജയപ്പെട്ടു. ദയവായി വീണ്ടും ശ്രമിക്കുക.", hi: "आपकी आवाज़ का प्रतिलेखन करने में विफल। कृपया पुन: प्रयास करें।", ta: "உங்கள் குரலை படியெடுக்க முடியவில்லை. దయచేసి మళ్లీ ప్రయత్నించండి.", te: "మీ குரலை படியெடுக்க முடியவில்லை. దయచేసి మళ్లీ ప్రయత్నించండి.", kn: "ನಿಮ್ಮ ಧ್ವನಿಯನ್ನು প্রতিলিপি ಮಾಡಲು ವಿಫലವಾಗಿದೆ. ದಯವಿಟ್ಟು ફરી પ્રયાસಿಸಿ.", bn: "আপনার ভয়েস প্রতিলিপি করতে ব্যর্থ। অনুগ্রহ করে 다시 চেষ্টা করুন।", mr: "तुमचा आवाज প্রতিলিপি करण्यात अयशस्वी. कृपया पुन्हा प्रयत्न करा.", gu: "તમારા અવાજને ટ્રાન્સક્રાઇબ કરવામાં નિષ્ફળ. કૃપા કરીને ફરી પ્રયાસ કરો.", pa: "ਤੁਹਾਡੀ ਆਵਾਜ਼ ਨੂੰ ਟ્રાన్స్ક્રਾਈਬ ਕਰਨ ਵਿੱਚ ਅਸਫਲ। ਕਿਰਪਾ ਕਰਕੇ ਦੁਬਾਰਾ ਕੋਸ਼ਿਸ਼ ਕਰੋ।" }),
      });
    } finally {
      setLoading(false);
    }
  ...
  const handleGetAdvice = async () => {
    if (!transcribedText.trim()) {
      toast({
        variant: "destructive",
        title: t({ en: "No text to analyze", ml: "വിശകലനം ചെയ്യാൻ ടെക്സ്റ്റ് ഇല്ല", hi: "विश्लेषण के लिए कोई पाठ नहीं", ta: "பகுப்பாய்வு செய்ய පෙළ இல்லை", te: "విశ్లేషించడానికి టెక్స్ట్ లేదు", kn: "ವಿశ్ਲੇಷಿಸಲು ಯಾವುದೇ ಪಠ್ಯವಿಲ್ಲ", bn: "تحليل করার জন্য কোনো পাঠ্য নেই", mr: "विश्लेषण करण्यासाठी कोणताही मजकूर नाही", gu: "વિશ્ਲੇષण કરવા માટે કોઈ ટેક્સ્ટ નથી", pa: "ਵਿਸ਼ਲੇਸ਼ਣ ਕਰਨ ਲਈ ਕੋਈ ਟੈਕਸਟ ਨਹੀਂ" }),
        description: t({ en: "Please record your question first.", ml: "ദയവായി ആദ്യം നിങ്ങളുടെ ചോദ്യം റെക്കോർഡ് ചെയ്യുക.", hi: "कृपया पहले अपना प्रश्न रिकॉर्ड करें।", ta: "దయచేసి మొదట మీ ప్రశ్నను రికార్డ్ చేయండి.", te: "దయచేసి మొదట మీ ప్రశ్నను రికార్ഡ് చేయండి.", kn: "దయವಿಟ್ಟು ಮೊದಲು ನಿಮ್ಮ ಪ್ರಶ್ನೆಯನ್ನು റെക്കോർഡ് ಮಾಡಿ.", bn: "অনুগ্রহ করে প্রথমে আপনার প্রশ্নটি রেকর্ড করুন।", mr: "कृपया आधी तुमचा प्रश्न रेकॉर्ड करा.", gu: "કૃપા કરીને પહેલા તમારો પ્રશ્ન રેકોર્ડ કરો.", pa: "ਕਿਰਪਾ ਕਰਕੇ ਪਹਿਲਾਂ ਆਪਣਾ ਸਵਾਲ ਰికਾਰਡ ਕਰੋ।" }),
      });
      return;
    }
  ...
  return (
    <>
      <Header
        title={t({ en: "Voice Query", ml: "ശബ്ദ ചോദ്യം", hi: "आवाज प्रश्न", ta: "குரல் கேள்வி", te: "వాయిస్ ప్రశ్న", kn: "ಧ್ವನಿ ಪ್ರಶ್ನೆ", bn: "ভয়েস কোয়েরি", mr: "आवाज प्रश्न", gu: "અવાજ ક્વેरी", pa: "ਅਵਾਜ਼ ਸਵਾਲ" })}
          ...
          <div className="flex flex-col gap-8">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {t({ en: "Press the button to start recording. Ask your question clearly.", ml: "റെക്കോർഡിംഗ് ആരംഭിക്കാൻ ബട്ടൺ അമർത്തുക. നിങ്ങളുടെ ചോദ്യം വ്യക്തമായി ചോദിക്കുക.", hi: "रिकॉर्डिंग शुरू करने के लिए बटन दबाएं। अपना प्रश्न स्पष्ट रूप سے पूछें।", ta: "பதிவுசெய்யத் தொடங்க பொத்தானை அழுத்தவும். உங்கள் கேள்வியைத் தெளிவாகக் கேளுங்கள்.", te: "రికార్డింగ్ ప్రారంభించడానికి బటన్‌ను నొక్కండి. మీ ప్రశ్నను స్పష్టంగా అడగండి.", kn: "ರೆಕಾರ್ഡിಂಗ್ ಪ್ರಾರಂಭಿಸಲು ബటನ್ ಒತ್ತಿರಿ. ನಿಮ್ಮ ಪ್ರಶ್ನೆಯನ್ನು સ્પಷ್ಟವಾಗಿ ಕೇಳಿ.", bn: "রেকর্ഡിଂ شروع করতে বোতামটি চাপুন। আপনার প্রশ্নটি સ્પષ્ટভাবে জিজ্ঞাসা করুন।", mr: "रेकॉर्डिंग सुरू करण्यासाठी बटण दाबा. तुमचा प्रश्न स्पष्टपणे विचारा.", gu: "રેકોર્ડिंग શરૂ કરવા માટે બટન દબાવો. તમારો પ્રશ્ન સ્પષ્ટપણે પૂછો.", pa: "ਰਿਕਾਰਡਿੰਗ ਸ਼ੁਰੂ ਕਰਨ ਲਈ ਬటਨ ਦਬਾਓ। ਆਪਣਾ ਸਵਾਲ ਸਪਸ਼ਟ रूपमा ਪੁੱਛੋ।" })}
                </CardDescription>
              </CardHeader>
              <CardContent className="flex flex-col items-center justify-center gap-6">
                ...
                {recording && (
                  <div className="flex items-center gap-2 text-muted-foreground">
                    ...
                    <span>{t({ en: "Recording...", ml: "റെക്കോർഡിംഗ്...", hi: "रिकॉर्डिंग...", ta: "பதிவுசெய்கிறது...", te: "రికార్డింగ్...", kn: "ರೆಕಾರ್ഡിಂಗ್...", bn: "রেকর্딩...", mr: "रेकॉर्डिंग...", gu: "રેકોर्डિંગ...", pa: "ਰਿਕਾਰਡਿੰਗ..." })}</span>
                  </div>
                )}
                 {audioUrl && !loading && (
                      <div className="w-full">
                          <p className="text-sm font-medium mb-2">{t({ en: "Your recording:", ml: "നിങ്ങളുടെ റെക്കോർഡിംഗ്:", hi: "आपकी रिकॉर्डिंग:", ta: "உங்கள் பதிவு:", te: "మీ రికార్డింగ్:", kn: "ನಿಮ್ಮ ರೆಕಾರ್ഡിಂಗ್:", bn: "আপনার রেকর্ডিং:", mr: "तुमची रेकॉर्डिंग:", gu: "તમારી રેકોર્ડિંગ:", pa: "ਤੁਹਾਡੀ ਰਿਕਾਰਡਿੰਗ:" })}</p>
             ...
             <Card>
              <CardHeader>
                  <CardTitle>{t({ en: "Step 2: Get Advice", ml: "ഘട്ടം 2: ഉപദേശം നേടുക", hi: "चरण 2: सलाह लें", ta: "படி 2: அறிவுரை பெறுங்கள்", te: "ഘട്ടം 2: సలహా పొందండి", kn: "ಹಂತ 2: ಸಲಹೆ ಪಡೆಯಿರಿ", bn: "ধাপ 2: পরামর্শ alın", mr: "पायरी 2: सल्ला घ्या", gu: "પગલું 2: સલાહ લો", pa: "ਕਦਮ 2: ਸਲਾહ ਲਓ" })}</CardTitle>
                  <CardDescription>
                   {t({ en: "Review the transcribed text and click the button for AI advice.", ml: "ട്രാൻസ്ക്രൈബ് ചെയ്ത വാചകം അവലോകനം ചെയ്ത് AI ഉപദേശത്തിനായി ബട്ടൺ ക്ലിക്കുചെയ്യുക.", hi: "प्रतिलेखित पाठ की समीक्षा करें और AI सलाह के लिए बटन पर क्लिक करें।", ta: "படியெடுத்த உரையை மதிப்பாய்வு செய்து, AI அறிவுரைக்கு பொத்தானைக் கிளிக் செய்யவும்.", te: "ట్రాన్స్క్రైబ్ చేసిన వచనాన్ని సమీక్షించి, AI సలహా కోసం బటన్‌ను క్లిక్ చేయండి.", kn: "ಪ್ರতিলિଖିത ಪಠ್ಯವನ್ನು ಪರಿಶೀಲಿಸಿ અને AI ಸಲಹೆಗಾಗಿ ബటನ್ ക്ലിಕ್ ಮಾಡಿ.", bn: " প্রতিলিপি করা पाठ পর্যালোচনা করুন এবং AI পরামর্শের জন্য বোতামে ক্লিক করুন।", mr: "ट्रान्सक्रिप्ट केलेला मजकूर तपासा आणि AI सल्ल्यासाठी बटणावर क्लिक करा.", gu: "ટ્રાన్స్ક્રાઇબ કરેલા ટેક્સ્ટની સમીક્ષા કરો અને AI સલાહ માટે બટન પર ક્લિક કરો.", pa: "ਟ్రాన్స్ਕ੍ਰਾਈਬ ਕੀਤੇ ਟੈਕਸਟ ਦੀ ਸਮીક્ષા ਕਰੋ ਅਤੇ AI ਸਲਾਹ ਲਈ ਬਟਨ 'ਤੇ ਕਲਿੱਕ ਕਰੋ।" })}
                  </CardDescription>
              </CardHeader>
               <CardContent>
                  <Textarea
                    placeholder={t({ en: "Transcribed text will appear here...", ml: "ട്രാൻസ്ക്രൈബ് ചെയ്ത വാചകം ഇവിടെ ദൃശ്യമാകും...", hi: "प्रतिलेखित पाठ यहां दिखाई देगा...", ta: "படியெடுத்த உரை இங்கே தோன்றும்...", te: "ట్రాన్స్క్రైబ్ చేసిన టెక్స్ట్ ఇక్కడ కనిపిస్తుంది...", kn: "ಪ್ರතිलिपि ಮಾಡಿದ ಪಠ್ಯ ಇಲ್ಲಿ ಕಾಣಿಸುತ್ತದೆ...", bn: "প্রতিলিপি করা পাঠ্য এখানে প্রদর্শিত হবে...", mr: "ट्रान्सक्रिप्ट केलेला मजकूर येथे दिसेल...", gu: "ટ్రాൻസ്ક્રાઈब કરેલ ટેક્સ્ટ અહીં દેખાશે...", pa: "ਲਿਪੀਅੰਤਰਿਤ ਟੈਕਸਟ ਇੱਥੇ ਦਿਖਾਈ ਦੇਵੇਗਾ..." })}
                    className="min-h-[100px] mb-4"
                    value={loading ? t({ en: "Transcribing...", ml: "ട്രാൻസ്ക്രൈബ് ചെയ്യുന്നു...", hi: "प्रतिलेखन...", ta: "படியெடுக்கிறது...", te: "ట్రాൻസ്క్రైబ్ చేస్తోంది...", kn: "ಪ್ರతిലിപി ಮಾಡಲಾಗುತ್ತಿದೆ...", bn: "প্রতিলিপি করা হচ্ছে...", mr: "ट्रान्सक्राइब करत आहे...", gu: "ટ્રાન્સક્રાઇબ કરી રહ્યું છે...", pa: "ਲਿਪੀਅੰतरित ਕੀਤਾ ਜਾ ਰਿਹਾ ਹੈ..." }) : transcribedText}
          ...
          <Card className="flex flex-col">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <Bot className="text-primary" /> {t({ en: "AI Recommendation", ml: "AI ശുപാർശ", hi: "एआई सिफारिश", ta: "AI பரிந்துரை", te: "AI సిఫార్సు", kn: "AI ಶಿಫಾರಸು", bn: "এഐ সুপারিশ", mr: "एआय शिफारस", gu: "AI ભલામણ", pa: "AI ਸਿਫਾਰਸ਼" })}
              </CardTitle>
              <CardDescription>
            ...
            <CardContent className="flex-grow">
              ...
              {!gettingAdvice && !advice && (
                <div className="flex items-center justify-center h-full text-muted-foreground text-center">
                  <p>{t({ en: "Your expert advice will be generated here.", ml: "നിങ്ങളുടെ വിദഗ്ദ്ധ ഉപദേശം ഇവിടെ ജനറേറ്റ് ചെയ്യും.", hi: "आपकी विशेषज्ञ सलाह यहां उत्पन्न होगी।", ta: "உங்கள் நிபுணர் அறிவுரை இங்கே உருவாக்கப்படும்.", te: "మీ నిపుణుల సలహా ఇక్కడ உருவாக்கబడుతుంది.", kn: "ನಿಮ್ಮ ತಜ್ಞರ ಸಲಹೆ અહીં üretilir.", bn: "আপনার বিশেষজ্ঞের পরামর্শ এখানে তৈরি হবে।", mr: "तुमचा तज्ञांचा सल्ला येथे तयार केला जाईल.", gu: "તમારી નિષ્ણાत સલાહ અહીં જનરેଟ થશે.", pa: "ਤੁਹਾਡੀ ਮਾਹਰ ਸਲਾਹ ਇੱਥੇ ਤਿਆਰ ਕੀਤੀ ਜਾਵੇਗੀ।" })}</p>
                </div>
              )}
            </CardContent>
          </Card>
