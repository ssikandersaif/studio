...
export default function DashboardPage() {
  ...
  const featureImages = {
      ...
      diary: PlaceHolderImages.find((img) => img.id === "farm-diary"),
  }
  ...
  const features = [
    ...
    { title: t({ en: "Farm Diary", hi: "फार्म डायरी" }), description: t({ en: "Log your farming activities", hi: "अपनी खेती की गतिविधियों को लॉग करें" }), href: "/farm-diary", icon: <NotebookPen className="w-8 h-8 text-primary" />, image: featureImages.diary },
