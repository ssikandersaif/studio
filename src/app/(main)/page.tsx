...
const secondaryFeatures = [
  ...
  {
    title: { en: "FAQ", ml: "പതിവുചോദ്യങ്ങൾ", hi: "सामान्य प्रश्न", ta: "அடிக்கடி கேட்கப்படும் கேள்விகள்", te: "తరచుగా అడిగే ప్రశ్నలు", kn: "ಪದೇ ಪದೇ ಕೇಳಲಾಗುವ ಪ್ರಶ್ನೆಗಳು", bn: "সাধারণ জিজ্ঞাসিত প্রশ্ন", mr: "वारंવાર विचारले जाणारे प्रश्न", gu: "વારંવાર પૂછાતા પ્રશ્નો", pa: "ਅਕਸਰ ਪੁੱਛੇ ਜਾਣ ਵਾਲੇ ਸਵਾਲ" },
                        ...
                        />
                         ...
                         <div className="relative z-20 flex flex-col justify-between h-full p-6 text-white">
                            <div>
                                ...
                                <p className="text-white/80 mt-1">{t({ en: "Identify crop diseases and pests instantly using your phone's camera.", hi: "अपने फोन के कैमरे का उपयोग करके फसल रोगों और कीटों की तुरंत पहचान करें।", ml: "നിങ്ങളുടെ ഫോണിന്റെ ക്യാമറ ഉപയോഗിച്ച് വിള രോഗങ്ങളും കീടങ്ങളും തൽക്ഷണം തിരിച്ചറിയുക.", ta: "உங்கள் தொலைபேசியின் கேமராவைப் பயன்படுத்தி பயிர் நோய்கள் மற்றும் பூச்சிகளை உடனடியாக அடையாளம் காணவும்.", te: "మీ ఫోన్ కెమెరాను ఉపయోగించి పంట వ్యాధులు మరియు తెగుళ్లను తక్షణమే గుర్తించండి.", kn: "ನಿಮ್ಮ ಫೋನ್‌ನ ಕ್ಯಾಮೆರಾವನ್ನು ಬಳಸಿಕೊಂಡು ಬೆಳೆ ರೋಗಗಳು ಮತ್ತು ಕೀಟಗಳನ್ನು ತಕ್ಷಣವೇ ಗುರುತಿಸಿ.", bn: "আপনার ফোনের ক্যামেরা ব্যবহার করে ফসলের রোগ ও কীটপতঙ্গ সঙ্গে সঙ্গে শনাক্ত করুন।", mr: "तुमच्या फोनच्या कॅमेराचा वापर करून पिकांचे रोग आणि कीड त्वरित ओळखा.", gu: "તમારા ફોનના કેમેરાનો ઉપયોગ કરીને પાકના રોગો અને જીવાતોને તરત જ ઓળખો.", pa: "ਆਪਣੇ ਫ਼ੋਨ ਦੇ ਕੈਮਰੇ ਦੀ ਵਰਤੋਂ ਕਰਕੇ ਫਸਲਾਂ ਦੀਆਂ ਬਿਮਾਰੀਆਂ ਅਤੇ ਕੀੜਿਆਂ ਦੀ ਤੁਰੰਤ ਪਛਾਣ ਕਰੋ।"})}</p>
                            </div>
